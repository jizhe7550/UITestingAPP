...
import com.jizhe7550.myapplication.ui.viewmodel.*
import com.jizhe7550.myapplication.ui.viewmodel.state.MAIN_VIEW_STATE_BUNDLE_KEY
import com.jizhe7550.myapplication.ui.viewmodel.state.MainStateEvent
import com.jizhe7550.myapplication.ui.viewmodel.state.MainStateEvent.GetAllBlogs
import com.jizhe7550.myapplication.ui.viewmodel.state.MainViewState
import com.jizhe7550.myapplication.util.ERROR_STACK_BUNDLE_KEY
import com.jizhe7550.myapplication.util.ErrorStack
import com.jizhe7550.myapplication.util.ErrorState
import com.jizhe7550.myapplication.util.printLogD
    ...
    private fun onMenuItemSelected(categories: List<Category>, menuItem: MenuItem): Boolean{
        for(category in categories){
            if(category.pk == menuItem.itemId){
                ...
                if(category.category_name == MENU_ITEM_NAME_GET_ALL_BLOGS){
